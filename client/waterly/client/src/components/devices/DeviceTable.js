...
const DeviceTable = ({userId}) => {
    const [columns, setColumns] = useState([
        ...
        {title: "Meter Reading [cubic millimeter]", field: "last_water_read", editable: 'never'},
        ...
        <Grid container>
            ...
            <div>
                ...
                <MaterialTable
                    ...
                    actions={[
                        rowData =>({
                            icon: () => <Link style={{ color: '#000' }} to={`/events/device/${rowData.id}/${rowData.name}`}><EventIcon/></Link>,
