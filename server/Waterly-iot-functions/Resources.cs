...
namespace Waterly_iot_functions
{
    public static class Resources
    {
        ...
        public static Container devices_container = cosmosClient.GetContainer("waterly_db", "waterly_devices");
        public static Container bill_container = cosmosClient.GetContainer("waterly_db", "bills_table");
